...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"utils/scrambleText.js":[function(require,module,exports) {
"use strict";
...
function scramble(element, text) {
...
},{"gsap":"../node_modules/gsap/index.js"}],"utils/listItemsReveal.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.listItemsReveal = listItemsReveal;
var _gsap = require("gsap");
function listItemsReveal(targetEl) {
  var blogSection = targetEl;
  var blogSectionListItems = blogSection.querySelectorAll(".blog-list_item");
  blogSectionListItems.forEach(function (item, index) {
    var divider = item.querySelector(".blog-list_divider");
    var heading = item.querySelector(".blog-list_question h3");
    //const category = item.querySelectorAll(".blog-list_category-wrap p");

    _gsap.gsap.set(divider, {
      width: "0%",
      opacity: 0
    });
    _gsap.gsap.set(heading, {
      y: "-100%",
      opacity: 0
    });
    var tl = _gsap.gsap.timeline({
...
},{"gsap":"../node_modules/gsap/index.js"}],"utils/navLinksHandler.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = navLinksHadler;
var _gsap = require("gsap");
var _scrambleText = _interopRequireDefault(require("./scrambleText"));
var _listItemsReveal = require("./listItemsReveal");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function navLinksHadler() {
  //Nav links hover
  var navLinks = document.querySelectorAll(".navbar_link");
  var navMenus = document.querySelectorAll(".nav-list_wrapper");
  function scrambleIn(link) {
    if (link.getAttribute("data-nav-link") === "projects") (0, _scrambleText.default)(link, "See work");
    if (link.getAttribute("data-nav-link") === "insights") (0, _scrambleText.default)(link, "Read blog");
    if (link.getAttribute("data-nav-link") === "contact") (0, _scrambleText.default)(link, "Let's connect");
  }
  function scrambleOut(link) {
    if (!link.classList.contains("is-opened")) {
      if (link.getAttribute("data-nav-link") === "projects") (0, _scrambleText.default)(link, "Projects");
      if (link.getAttribute("data-nav-link") === "insights") (0, _scrambleText.default)(link, "Insights");
      if (link.getAttribute("data-nav-link") === "contact") (0, _scrambleText.default)(link, "Contact me");
    } else (0, _scrambleText.default)(link, "Close");
  }
  ...
  function openNavMenu(link) {
    ...
    navMenus.forEach(function (menu) {
      menu.getAttribute("data-nav-list") === name ? menu.classList.add("is-opened") : null;
      var target = document.querySelector("[data-nav-list=".concat(name, "]"));
      if (menu.classList.contains("is-opened")) {
        if (menu.getAttribute("data-nav-list") !== name) {
          var tlOut = _gsap.gsap.timeline();
          var tlIn = _gsap.gsap.timeline();
          tlOut.to(menu, {
            top: "auto",
            duration: 0
          }).to(menu, {
          ...
          tlIn.call(function () {
            (0, _listItemsReveal.listItemsReveal)(target);
          }).to("[data-nav-list=".concat(name, "]"), {
            height: "100vh",
            duration: 0.8,
            ease: "power4.out"
          }, 0.2);
  ...
  navLinks.forEach(function (link) {
    ...
    link.addEventListener("mouseover", function () {
      if (link.classList.contains("is-opened")) {
        (0, _scrambleText.default)(link, "Close");
    ...
    link.addEventListener("click", function (e) {
      navLinks.forEach(function (link) {
        var name = link.getAttribute("data-nav-link");
        var dropdown = document.querySelector("[data-nav-list=".concat(name, "]"));
        if (link === e.currentTarget) {
          if (!link.classList.contains("is-opened")) {
            ...
            tl.to("[data-nav-list].is-opened", {
              ...
              duration: 0.8,
              ease: "power4.in"
            }).to(".blog-list_question h3", {
              opacity: 0,
              stagger: {
                each: 0.05,
                start: "end"
              }
            }, 0.2).to(".blog-list_divider", {
              opacity: 0,
              width: "0%",
              stagger: {
                each: 0.05,
...
},{"gsap":"../node_modules/gsap/index.js","./scrambleText":"utils/scrambleText.js","./listItemsReveal":"utils/listItemsReveal.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","utils/navLinksHandler.js"], null)
//# sourceMappingURL=/utils/navLinksHandler.js.map